...
fun <V : android.view.View> android.support.v4.app.DialogFragment.bindView(id: Int)
    : kotlin.properties.ReadOnlyProperty<android.support.v4.app.DialogFragment, V> = required(id,
    viewFinder)
...
fun <V : android.view.View> android.support.v4.app.Fragment.bindView(id: Int)
    : kotlin.properties.ReadOnlyProperty<android.support.v4.app.Fragment, V> = required(id,
    viewFinder)
...
fun <V : android.view.View> android.support.v4.app.DialogFragment.bindOptionalView(id: Int)
    : kotlin.properties.ReadOnlyProperty<android.support.v4.app.DialogFragment, V?> = optional(id,
    viewFinder)
...
fun <V : android.view.View> android.support.v4.app.Fragment.bindOptionalView(id: Int)
    : kotlin.properties.ReadOnlyProperty<android.support.v4.app.Fragment, V?> = optional(id,
    viewFinder)

fun <V : android.view.View> android.support.v7.widget.RecyclerView.ViewHolder.bindOptionalView(
    id: Int)
...
fun <V : android.view.View> android.support.v4.app.DialogFragment.bindViews(vararg ids: Int)
    : kotlin.properties.ReadOnlyProperty<android.support.v4.app.DialogFragment, List<V>> = required(
    ids, viewFinder)
...
fun <V : android.view.View> android.support.v4.app.Fragment.bindViews(vararg ids: Int)
    : kotlin.properties.ReadOnlyProperty<android.support.v4.app.Fragment, List<V>> = required(ids,
    viewFinder)

fun <V : android.view.View> android.support.v7.widget.RecyclerView.ViewHolder.bindViews(
    vararg ids: Int)
...
fun <V : android.view.View> android.support.v4.app.DialogFragment.bindOptionalViews(vararg ids: Int)
    : kotlin.properties.ReadOnlyProperty<android.support.v4.app.DialogFragment, List<V>> = optional(
    ids, viewFinder)
...
fun <V : android.view.View> android.support.v4.app.Fragment.bindOptionalViews(vararg ids: Int)
    : kotlin.properties.ReadOnlyProperty<android.support.v4.app.Fragment, List<V>> = optional(ids,
    viewFinder)

fun <V : android.view.View> android.support.v7.widget.RecyclerView.ViewHolder.bindOptionalViews(
    vararg ids: Int)
...
@Suppress("UNCHECKED_CAST")
private fun <T, V : android.view.View> required(ids: IntArray,
    finder: T.(Int) -> android.view.View?)
    = Lazy { t: T, desc -> ids.map { t.finder(it) as V? ?: viewNotFound(it, desc) } }

@Suppress("UNCHECKED_CAST")
private fun <T, V : android.view.View> optional(ids: IntArray,
    finder: T.(Int) -> android.view.View?)
    = Lazy { t: T, _ -> ids.map { t.finder(it) as V? }.filterNotNull() }

// Like Kotlin's lazy delegate but the initializer gets the target and metadata passed to it
private class Lazy<in T, out V>(
    private val initializer: (T, kotlin.reflect.KProperty<*>) -> V) : kotlin.properties.ReadOnlyProperty<T, V> {
